...
class Coat(Clothes):
    ...
    def __str__(self):
        return f'Пальто: размер {self.size}, расход ткани {self.expence}, общий расход ткани {Coat.expence_count:.02f} единиц'
...
class Costume(Clothes):
    ...
    def __str__(self):
        return f'Костюм: рост {self.height}, расход ткани {self.expence}, общий расход ткани {Costume.expence_count:.02f} единиц'
